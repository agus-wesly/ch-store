...
function Navbar({ isShowSearch }: IProps) {
  ...
  return (
    <>
      <nav className="w-full max-w-[100vw] overflow-hidden left-0 bg-white shadow-[0_4px_6px_-1px_rgba(0,0,0,0.07)] z-10 px-5 md:px-10 py-5 flex items-center fixed z-5 top-0 justify-between space-x-5">
        <Link href="/">
